...
[![GitHub stars](https://img.shields.io/github/stars/你的用户名/trae_auto_sign?style=social)](https://github.com/你的用户名/trae_auto_sign/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/你的用户名/trae_auto_sign?style=social)](https://github.com/你的用户名/trae_auto_sign/network/members)
[![License](https://img.shields.io/github/license/你的用户名/trae_auto_sign)](LICENSE)
[![Last Commit](https://img.shields.io/github/last-commit/你的用户名/trae_auto_sign)](https://github.com/你的用户名/trae_auto_sign/commits/main)
[![GitHub Actions](https://github.com/你的用户名/trae_auto_sign/actions/workflows/签到.yml/badge.svg)](https://github.com/你的用户名/trae_auto_sign/actions)
...
- **2026-08-03**：优化脚本逻辑，支持环境变量注入 Token。
- **2026-08-02**：增加随机延迟和一日两次尝试，提高签到成功率。
